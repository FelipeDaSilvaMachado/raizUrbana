...
<head>
    ...
    <link rel="stylesheet" href="../cssAdmin/produtos_admin.css">
    <title>Produtos - Raiz Urbana</title>
</head>
<body>
    <div class="header">
        <div class="cabeçalho">
        ...
        <nav class="navegação">
            <div class="menu-centro">
                <ul>
                    ...
                    <li>
                        <a href="produtos_admin.php">VESTUÁRIO</a>
                    <ul class="dropdown">
                        <li><a href="modaMasculina_admin.php">MASCULINO</a></li>
                        <li><a href="modaFeminina_admin.php">FEMININO</a></li>
                    </ul>
                    </li>
...
<a href="cadastrar_produto.php" class="cadastrar-produto">
    ...
    <div class="container">
        <div class="card_container">
            ...
            <article class="card_article">
                ...
                <a href="produto_info_admin.php?id=<?= $p['id'] ?>" class="card_button">
    ...
    <div class="container">
        <?php if (empty($produtos)): ?>
            <div class="no-products">
                ...
                <a href="produtos_admin.php" class="back-link">Voltar para todos os produtos</a>
            </div>
        <?php else: ?>
            <div class="card_container">
                <?php foreach ($produtos as $p): ?>
    ...
    <footer>
        <div class="conteudo_rodape">
            ...
            <ul class="footer-list">
                ...
                <li><h5 class="footer-contato">SAC: WHATSAPP: (11)91581-5984</h5></li>
                <li>
