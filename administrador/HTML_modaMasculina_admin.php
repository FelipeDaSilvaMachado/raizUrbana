...
<head>
    ...
    <link rel="stylesheet" href="../cssAdmin/modaMasculina_admin.css">
    <title>Moda Masculina - Raiz Urbana</title>
</head>
<body>
    <div class="header">
        <div class="cabeçalho">
    ...
    <br><br><br><br>
    <h1 class="titulo">MODA Masculina</h1>
    ...
    <div class="container">
        <?php if (empty($produtos)): ?>
            <div class="no-products">
                ...
                <a href="modaMasculina_admin.php" class="back-link">Voltar para todos os produtos</a>
            </div>
        <?php else: ?>
            <div class="card_container">
                <?php foreach ($produtos as $p): ?>
